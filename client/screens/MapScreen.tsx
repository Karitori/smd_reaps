...
import { Button, Dimensions, FlatList, SafeAreaView, StyleSheet, Text, TouchableOpacity, View } from "react-native";
...
const SearchResults = () => {
  ...
  useEffect(() => {
    Promise.all([
      axios.default.get(`http://192.168.2.244:3000/locations/${term}`),
